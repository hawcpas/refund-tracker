...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Future<void> _updatePassword() async {
    ...
    final code = await _auth.updatePassword(newPasswordController.text.trim());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ✅ Ensures background is painted behind body too
      body: ColoredBox(
        color: AppColors.pageBackgroundLight,
        child: ListView(
          // ✅ Adds horizontal padding so you can SEE the background around the card
